...
#define MAVLINK_ROS2_TO_MCU_XML_HASH 7672229972731987135
...
#define MAVLINK_MESSAGE_CRCS {{50002, 194, 2, 2, 0, 0, 0}, {50003, 149, 1, 1, 0, 0, 0}, {50004, 158, 5, 5, 0, 0, 0}}
#endif
...
#include "./mavlink_msg_gorur_gari_ros2_to_mcu_timer_msg.h"
...
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_gorur_gari_ros2_to_mcu_msg, MAVLINK_MESSAGE_INFO_gorur_gari_ros2_to_mcu_connect_msg, MAVLINK_MESSAGE_INFO_gorur_gari_ros2_to_mcu_timer_msg}
# define MAVLINK_MESSAGE_NAMES {{ "gorur_gari_ros2_to_mcu_connect_msg", 50003 }, { "gorur_gari_ros2_to_mcu_msg", 50002 }, { "gorur_gari_ros2_to_mcu_timer_msg", 50004 }}
