"""
First round: the full driving stack, no obstacles on the mat, with inverted LiDAR.
    ...
    rplidar_c1          sensors     serial link to LiDAR - drives /scan out (inverted)
...
Run it from the workspace root:
    ...
    ros2 launch launch/first_round.launch.py
"""
import os
