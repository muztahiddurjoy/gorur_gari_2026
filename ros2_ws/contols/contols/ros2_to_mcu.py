...
Generated from: ('ros2_to_mcu.xml',)
...
class MAVLink_gorur_gari_ros2_to_mcu_msg_message(MAVLink_message):
    ...
    id = MAVLINK_MSG_ID_GORUR_GARI_ROS2_TO_MCU_MSG
    ...
    def __init__(self, throttle: int, steering: int):
        MAVLink_message.__init__(self, MAVLink_gorur_gari_ros2_to_mcu_msg_message.id, MAVLink_gorur_gari_ros2_to_mcu_msg_message.msgname)
        self._fieldnames = MAVLink_gorur_gari_ros2_to_mcu_msg_message.fieldnames
        self._instance_field = MAVLink_gorur_gari_ros2_to_mcu_msg_message.instance_field
        self._instance_offset = MAVLink_gorur_gari_ros2_to_mcu_msg_message.instance_offset
        self.throttle = throttle
        self.steering = steering

    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.throttle, self.steering), force_mavlink1=force_mavlink1)
...
class MAVLink(object):
    ...
    def gorur_gari_ros2_to_mcu_msg_encode(self, throttle: int, steering: int) -> MAVLink_gorur_gari_ros2_to_mcu_msg_message:
        """
        Gorur Gari ROS2 to MCU Serial Message
        ...
        """
        return MAVLink_gorur_gari_ros2_to_mcu_msg_message(throttle, steering)

    def gorur_gari_ros2_to_mcu_msg_send(self, throttle: int, steering: int, force_mavlink1: bool = False) -> None:
        """
        Gorur Gari ROS2 to MCU Serial Message
