...
Generated from: ('mcu_to_ros2.xml',)
...
MAVLINK_MSG_ID_GORUR_GARI_MCU_TO_ROS2_MSG = 50001


class MAVLink_gorur_gari_mcu_to_ros2_msg_message(MAVLink_message):
    """
    ...
    def __init__(self, encoder_count: int, encoder_speed: int, encoder_direction: int, servo: int, sonar_1: int, sonar_2: int, sonar_3: int, sonar_4: int):
        ...
        self._instance_offset = MAVLink_gorur_gari_mcu_to_ros2_msg_message.instance_offset
...
setattr(MAVLink_gorur_gari_mcu_to_ros2_msg_message, "name", mavlink_msg_deprecated_name_property())


mavlink_map: Dict[int, Type[MAVLink_message]] = {
    MAVLINK_MSG_ID_GORUR_GARI_MCU_TO_ROS2_MSG: MAVLink_gorur_gari_mcu_to_ros2_msg_message,
}
...
class MAVLink(object):
    ...
    def gorur_gari_mcu_to_ros2_msg_encode(self, encoder_count: int, encoder_speed: int, encoder_direction: int, servo: int, sonar_1: int, sonar_2: int, sonar_3: int, sonar_4: int) -> MAVLink_gorur_gari_mcu_to_ros2_msg_message:
        """
        Gorur Gari MCU to ROS2 Serial Message
        ...
        """
        return MAVLink_gorur_gari_mcu_to_ros2_msg_message(encoder_count, encoder_speed, encoder_direction, servo, sonar_1, sonar_2, sonar_3, sonar_4)

    def gorur_gari_mcu_to_ros2_msg_send(self, encoder_count: int, encoder_speed: int, encoder_direction: int, servo: int, sonar_1: int, sonar_2: int, sonar_3: int, sonar_4: int, force_mavlink1: bool = False) -> None:
        """
        Gorur Gari MCU to ROS2 Serial Message
        ...
        """
        self.send(self.gorur_gari_mcu_to_ros2_msg_encode(encoder_count, encoder_speed, encoder_direction, servo, sonar_1, sonar_2, sonar_3, sonar_4), force_mavlink1=force_mavlink1)
